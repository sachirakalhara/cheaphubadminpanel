...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
export async function getOrdersByCustomerId(customerId,page) {
    const apiObject = {}
    apiObject.method = 'GET'
    apiObject.authentication = true
    apiObject.isBasicAuth = false
    apiObject.urlencoded = false
    apiObject.endpoint = `orders/${customerId}?page=${page}`
    apiObject.body = null
    apiObject.multipart = false
...
export async function refundOrder(body) {
    const apiObject = {}
    apiObject.method = 'POST'
    apiObject.authentication = true
    apiObject.isBasicAuth = false
    apiObject.urlencoded = false
    apiObject.endpoint = `super-admin/order/refund`
    apiObject.body = body
    apiObject.multipart = false
...
export async function getOrderNotesByOrderId(id) {
    ...
    apiObject.isBasicAuth = false
    apiObject.urlencoded = false
    apiObject.endpoint = `super-admin/order/notes/${id}`
    apiObject.body = null
    apiObject.multipart = false
...
export async function addNoteHandler(body) {
    const apiObject = {}
    apiObject.method = 'POST'
    apiObject.authentication = true
    apiObject.isBasicAuth = false
    apiObject.urlencoded = false
    apiObject.endpoint = `super-admin/order/add-note`
    apiObject.body = body
    apiObject.multipart = false
