                        ...
                        <CardBody className='invoice-padding pb-0'>
                            ...
                            <div className="d-inline-flex w-100 align-items-center justify-content-between">
                                ...
                                <CardText tag="h6" className='text-black-50'>
                                    <Badge
                                        color={orderDetails.payment_status === 'paid' || orderDetails.payment_status === 'completed' ? 'success' : orderDetails.payment_status === 'pending' ? 'warning' : orderDetails.payment_status === 'refunded' ? 'info' : orderDetails.payment_status === 'canceled' ? 'secondary' : 'danger'}>{orderDetails.payment_status}
                                    </Badge>
                                </CardText>
                            </div>
